...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = _ractive2.default.components.Header = _ractive2.default.extend({
...
/***/ function(module, exports) {
	...
	module.exports = "<div id=\"header\" class=\"row\">\n    <div id=\"logo\" class=\"desktop-6 tablet-4 mobile-3\">\n        <a on-click=\"goto:home\"><img src=\"./img/logo.svg\" alt=\"\" style=\"border: 0;\"></a>\n    </div>\n    <div id=\"search\" class=\"desktop-3 tablet-1 mobile-6\">\n        <i class=\"fa fa-search\"></i>\n        <input type=\"text\" name=\"q\" id=\"q\" class=\"search-field\" placeholder=\"Search\" value = {{ searchTerm }}>\n    </div>\n    <ul id=\"cart\" class=\"desktop-6 tablet-3 mobile-3\">\n        <li>\n            {{#if beTokenError && beTokenError != ''}}\n                <div class=\"error\">\n                    {{beTokenError}}\n                </div>\n            {{/if}}\n            \n            {{#if user}}\n                Hi, {{ user.name }} | <a on-click=\"logout\">Logout</a> \n            {{else}}\n            <!-- <a on-click=\"goto:profile\">My account</a> | -->\n            <a on-click=\"login\">Login</a>| \n            <a on-click=\"register\">Register</a>\n            {{/if}}\n        </li>\n    </ul>\n</div>\n<div class=\"clear\"></div>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navigation = _ractive2.default.components.Navigation = _ractive2.default.extend({
...
/***/ function(module, exports) {
	...
	module.exports = "<div id=\"navigation\" class=\"row\">\n    <nav class=\"primary\">\n        <ul id=\"nav\" class=\"desktop-12\">\n            {{#if sources}} \n                {{#each sources:i}}\n                <li>\n                  <a on-click=\"filterBySource\">{{name}}</a>\n                <!-- <span class=\"arrow-down\"></span> -->\n                </li>\n                {{/each}} \n            {{/if}}\n        <!-- </ul> -->\n    </nav>\n</div>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = _ractive2.default.components.Footer = _ractive2.default.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	routes.set('/user/:username', function (context, next) {
	    _user2.default.findByName(context.params.username).then(function (user) {
	        next(null, _userPage2.default, {
	            user: user
	        });
	    }).catch(function (err) {
	        next(err);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HomePage = _ractive2.default.components.HomePage = _ractive2.default.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _profileSection = __webpack_require__(22);

	var _profileSection2 = _interopRequireDefault(_profileSection);

	var _reposSection = __webpack_require__(24);

	var _reposSection2 = _interopRequireDefault(_reposSection);

	var _notesSection = __webpack_require__(26);

	var _notesSection2 = _interopRequireDefault(_notesSection);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var UserPage = _ractive2.default.components.UserPage = _ractive2.default.extend({
	    template: _userPage2.default,
	    components: {
	        UserProfile: _profileSection2.default,
	        Repos: _reposSection2.default,
	        Notes: _notesSection2.default
	    },
	    oninit: function oninit() {
	        var _this = this;

	        this.observe('req', function (request) {
	            _this.set('user', request.body.user);
	        });

	        // *.*, *.AddUserNote, AddNote.*, AddNote.AddUserNote
	        this.on('*.AddUserNote', function (newNote) {
	            console.log('UserPage::createNote# Adding new note to user:', _this.get('user').profile.login);
	            _this.get('user').addNote(newNote);
	        });

	        this.on('*.RemoveUserNote', function (note) {
	            _this.get('user').removeNote(note);
	        });
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _profileSection = __webpack_require__(23);

	var _profileSection2 = _interopRequireDefault(_profileSection);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var UserProfileSection = _ractive2.default.extend({
	    isolated: true,
	    template: _profileSection2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reposSection = __webpack_require__(25);

	var _reposSection2 = _interopRequireDefault(_reposSection);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var ReposSection = _ractive2.default.extend({
	    isolated: true,
	    template: _reposSection2.default
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _notesSection = __webpack_require__(27);

	var _notesSection2 = _interopRequireDefault(_notesSection);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var NotesSection = _ractive2.default.extend({
	    isolated: true,
	    template: _notesSection2.default
	});

	exports.default = NotesSection;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FIREBASE_BASE_URL = 'https://ps-github-saver.firebaseio.com';

	var User = function () {
	    function User(profile, repos, notes) {
	    ...
	    _createClass(User, [{
	        key: 'addNote',
	        value: function addNote(newNote) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lscache = __webpack_require__(31);
	...
	function getJson(url) {
	    ...
	    return fetch(url).then(checkResponseStatus).then(parseJson).then(toJ());
	    // }
	}
