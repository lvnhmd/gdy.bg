...
2. aws s3 cp build s3://swagbag.club-source-dev/ --recursive --exclude ".DS_Store" --exclude "parameters-dev.json" "parameters-prod.json"

3. 
@home
-pink one
aws cloudformation create-stack  --stack-name swagbag-club-dev --template-url https://s3-eu-west-1.amazonaws.com/swagbag.club-source/cloudformation-template-update-stack-param.json --parameters file:///Users/elvin/gdy.bg/gdy.bg-api/build/parameters-dev.json --capabilities CAPABILITY_NAMED_IAM
-big one 
aws cloudformation create-stack  --stack-name swagbag-club-dev --template-url https://s3-eu-west-1.amazonaws.com/swagbag.club-source/cloudformation-template-update-stack-param.json --parameters file:///Users/elvinali/gdy.bg/gdy.bg-api/build/parameters-dev.json --capabilities CAPABILITY_NAMED_IAM

@work
aws cloudformation create-stack  --stack-name swagbag-club-dev --template-url https://s3-eu-west-1.amazonaws.com/swagbag.club-source/cloudformation-template-update-stack-param.json --parameters file:///Users/alie/elvin-workspace/gdy.bg/gdy.bg-api/build/parameters-dev.json --capabilities CAPABILITY_NAMED_IAM
---
