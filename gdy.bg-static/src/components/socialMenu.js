            ...
            return (
                <ul className="global__list-reset">
                    <li className="n-menu__social-item">
                        <a href="https://www.facebook.com/BritishVogue/"
                            title="Facebook"
                            className="n-main__dropdown__btn-share n-main__dropdown__btn-share--facebook"
                            target="_blank">
                    ...
                    <li className="n-menu__social-item">
                        <a href="https://twitter.com/ClubSwagbag" title="Twitter"
                            className="n-main__dropdown__btn-share n-main__dropdown__btn-share--twitter"
                            target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                    ...
                    <li className="n-menu__social-item">
                        <a href="https://www.instagram.com/britishvogue/" title="Instagram"
                            className="n-main__dropdown__btn-share n-main__dropdown__btn-share--instagram"
                            target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
